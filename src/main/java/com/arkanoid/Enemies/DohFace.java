...
public class DohFace extends Enemies {
    ...
    public DohFace(AnchorPane scene) {
        ...
        this.getRectangle().setX(X - this.getRectangle().getWidth() / 2);
        this.getRectangle().setY(Y - this.getRectangle().getHeight() / 2);
                    ...
                    if (imageCooldown <= 0) {
                        ...
                        if (imageState == 3) { // ...and the boss is opening his mouth...
                            ...
                            for (int i = 0; i < 4; i++) { // ...shoot
                                if (child[i] != null) {
                                    double X = child[i].getRectangle().getX();
                                    double Y = child[i].getRectangle().getY()
